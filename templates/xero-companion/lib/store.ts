/**
 * Credential storage for the xero-companion pairing state.
 *
 * Three values persist in expo-secure-store after the operator pairs this app
 * to their xero-proxy Worker:
 *   - workerUrl: HTTPS base URL (e.g. https://xero-proxy.foo.workers.dev)
...
const K_URL = "xeroproxy.url";
const K_SLUG = "xeroproxy.slug";
const K_SECRET = "xeroproxy.secret";
