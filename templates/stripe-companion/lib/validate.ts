 ...
 *      client burns a Worker request + a Stripe API call for nothing.
 ...
 * the state resets, and that is intentional, the server-side gate is the
 * load-bearing check.
 *
 ...
 * inference cost.
 *
 * This file is byte-for-byte the same as templates/xero-companion/lib/
 * validate.ts. Templates are intentionally self-contained per the
 * templates/README.md memory; the duplication is deliberate.
 */
